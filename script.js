...
const questions = [
  ...
  },
  {
    ...
    options: ["Ali Khamenei", "Hassan Rouhani", "Qasem Soleimani", "Mahmoud Ahmadinejad"],
    answer: 2,
    explain: "O general Qasem Soleimani foi morto em Bagdá por ordem do presidente Trump."
  },
  {
  ...
  },
  {
    ...
    options: ["#OscarsDiversity", "#OscarsSoWhite", "#OscarsInclusion", "#BlackOscars"],
    answer: 1,
    explain: "#OscarsSoWhite viralizou em 2015 e 2016, questionando a falta de indicados negros."
  },
  {
    q: "Qual filme brasileiro foi indicado ao Oscar de Melhor Filme Internacional em 2003?",
    options: ["Tropa de Elite", "Central do Brasil", "Cidade de Deus", "O Auto da Compadecida"],
    answer: 2,
    explain: "Cidade de Deus, de Fernando Meirelles, concorreu em 2003 — inclusive a Melhor Diretor."
  },
  {
    q: "Qual é a taxa aproximada de analfabetismo no Brasil atualmente?",
    options: ["20%", "15%", "7%", "2%"],
    answer: 2,
    explain: "O analfabetismo caiu de ~20% nos anos 90 para cerca de 7% nos últimos anos."
  }
];
...
function showResult() {
  ...
  document.getElementById('result-title').textContent = `${emoji} ${score}/${questions.length} acertos`;
  document.getElementById('result-text').textContent =
    pct === 100 ? 'Perfeito! Você dominou todos os temas!'
      : pct >= 80 ? 'Excelente! Você estudou bem o material.'
        : pct >= 50 ? 'Bom trabalho! Vale revisar alguns tópicos.'
